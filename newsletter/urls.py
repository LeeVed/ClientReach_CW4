...
from .views import DispatchLogListView
...
urlpatterns = [
    ...
    path("dispatches/<int:pk>/pause/", views.dispatch_pause_view, name="dispatch_pause"),
    path("dispatches/<int:pk>/resume/", views.dispatch_resume_view, name="dispatch_resume"),
    ...
    path("logs/", DispatchLogListView.as_view(), name="dispatch_log_list"),
